...
if initialize == "1":
    ...
    w1 = np.load('ex51_w1.npy')
    b1 = np.load('ex51_b1.npy')
    w2 = np.load('ex51_w2.npy')
    b2 = np.load('ex51_b2.npy')
...
for i in range(500):
    ...
    w1 = w1 + MOMENTUM_ALPHA * del_w1 - LEARNING_RATE * en_w_1
    del_w1 = MOMENTUM_ALPHA * del_w1 - LEARNING_RATE * en_w_1
    w2 = w2 + MOMENTUM_ALPHA * del_w2 - LEARNING_RATE * en_w_2
    del_w2 = MOMENTUM_ALPHA * del_w2 - LEARNING_RATE * en_w_2
...
print(w2)
print(b2)
np.save('ex51_w1.npy', w1)
np.save('ex51_w2.npy', w2)
np.save('ex51_b1.npy', b1)
np.save('ex51_b2.npy', b2)
