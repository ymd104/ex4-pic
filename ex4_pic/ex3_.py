...
if initialize == "1":
    ...
    w1 = np.load('ex3_w1.npy')
    b1 = np.load('ex3_b1.npy')
    w2 = np.load('ex3_w2.npy')
    b2 = np.load('ex3_b2.npy')
...
print(w2)
print(b2)
np.save('ex3_w1.npy', w1)
np.save('ex3_w2.npy', w2)
np.save('ex3_b1.npy', b1)
np.save('ex3_b2.npy', b2)
